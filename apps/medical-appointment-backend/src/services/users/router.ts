...
import { validateAuth, validateUserRole, validateBody, validateParams } from "@modules/validate";
...
router.get("/patients/info", validateAuth(), validateUserRole("P", "A"), validateParams(UsersPatientsInfoRequestSchema), controller.patientsInfo.bind(controller));
router.get("/doctors/info", validateAuth(), validateUserRole("D", "A"), validateParams(UsersDoctorsInfoRequestSchema), controller.doctorsInfo.bind(controller));
